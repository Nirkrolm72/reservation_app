    ...
    <div className='header'>
        <div className={type === 'list' ? "headerContainer listMode" : "headerContainer"}>
            ...
            <p className="headerDesc">
                Get rewarded for your travels - unclock instant savings of 10% or more with a free Booking App account
            </p>
            ...
            <div className="headerSearch">
                ...
                <div className="headerSearchItem">
                    ...
                    <span className='headerSearchText' onClick={() => setOpenOption(!openOptions)} >{`${options.adult} adult . ${options.children} children . ${options.room} room`}</span>
